...
#ifndef MFRC522_SPI
#define MFRC522_SPI						SPI5
#endif

/* Default CS pin used */
#ifndef MFRC522_CS_PIN
#define MFRC522_CS_PORT					GPIOF
...
#define MFRC522_CS_LOW					HAL_GPIO_WritePin(GPIOF, GPIO_PIN_6, GPIO_PIN_RESET)
#define MFRC522_CS_HIGH					HAL_GPIO_WritePin(GPIOF, GPIO_PIN_6, GPIO_PIN_SET)
