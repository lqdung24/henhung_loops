...
__Đề bài/Mục tiêu sản phẩm__: Máy thổi nồng độ cồn thông minh sử dụng vi điều khiển STM32F429 kết hợp với giao diện người dùng TouchGFX. Thiết bị hỗ trợ đo nồng độ cồn qua hơi thở và định danh người dùng bằng thẻ nhân viên NFC.
...
- Thành viên trong nhóm
  ...
  | --: | -- | -- | -- |
  | 1 | Lê Quang Dũng | 20235301 | nhiệm vụ? |
  | 2 | Lưu Quốc Dũng | 20235302 | nhiệm vụ? |
  | 3 | Lê Nghĩa Hiệp | 20235326 | nhiệm vụ? |
  | 4 | Nguyễn Xuân Hoàng | 20230078 | nhiệm vụ? |
  | 5 | Trần Bá Lợi | 20225358 | nhiệm vụ? |
